MonsterPalettes:
	...
	db PAL_MEWMON    ; MEW
	db PAL_BROWNMON  ; ORBALLOON
	db PAL_BROWNMON  ; NEEDLER
	db PAL_BROWNMON  ; KREEP
	db PAL_BROWNMON  ; BUCKSTOP
	db PAL_BROWNMON  ; ROARDAN
	db PAL_BROWNMON  ; JAWKRAKEN
	db PAL_BROWNMON  ; GANDESHA
