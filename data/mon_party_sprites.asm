MonPartyData:
	...
	dn SPRITE_MON, SPRITE_BALL_M            ;Mew/Orballoon
	dn SPRITE_GRASS, SPRITE_MON            ;NEEDLER/KREEP
	dn SPRITE_QUADRUPED, SPRITE_MON            ;BUCKSTOP/ROARDAN
	dn SPRITE_WATER, SPRITE_MON            ;JAWKRAKEN/GANDESHA
